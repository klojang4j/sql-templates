 ...
 * {@link SQL#expression(String)} native SQL expression} before saving it to the database.
 * SQL expressions will be injected as-is into the INSERT statement.
 * <i>Klojang JDBC</i> will not attempt to "understand" them. That makes you responsible
 * for protecting yourself against SQL injection. Using a {@code Quoter} gives you just as
 * much protection as {@link java.sql.PreparedStatement prepared statements} as it
 * completely outsources the quoting and escaping to the JDBC driver.
 *
