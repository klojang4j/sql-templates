...
public sealed interface SQL permits AbstractSQL {
  ...
  /**
   * Returns an {@link InsertBuilder} that enables you to configure a {@link SQLInsert}
   * object.
   *
   * @return an {@link InsertBuilder} that enables you to configure a {@link SQLInsert}
   *       object
   */
  ...
  /**
   * Returns a {@code BatchInsertBuilder} that enables you to configure a
   * {@link BatchInsert} object.
   *
   * @return a {@code BatchInsertBuilder} that enables you to configure a
   *       {@link BatchInsert} object
   */
  ...
  /**
   * Returns a {@code SQLSession} that allows you to execute the SQL.
   *
   * @param con the JDBC connection to use
   * @return a {@code SQLSession} that allows you to execute the SQL
   */
