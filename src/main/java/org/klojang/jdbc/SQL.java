...
public sealed interface SQL permits AbstractSQL {
   ...
   * saved in a {@link SQLBatchInsert}. Note that this makes you responsible for ensuring
   * that the specified string does not and cannot suffer from SQL injection.
   *
