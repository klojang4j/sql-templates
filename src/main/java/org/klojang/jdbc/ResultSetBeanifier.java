...
/**
 * Converts the rows in a JDBC {@link ResultSet result sets} into JavaBeans. Contrary to
 * the {@link SQLQuery} class a {@code ResultSetBeanifier} is completely agnostic about
 * how you got hold of the {@code ResultSet} and by what means it was created. You cannot
 * instantiate a {@code ResultSetBeanifier} directly. You obtain one from a
 * {@link BeanifierFactory}. When using a {@code ResultSetBeanifier} to iterate over a
 * {@code ResultSet}, do not call {@link ResultSet#next()}) yourself. This is done by the
