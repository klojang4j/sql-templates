...
public final class SQLInsert extends SQLStatement<SQLInsert> {
  ...
  /**
   * Executes the INSERT statement. If any JavaBean was bound while also specifying the
   * property representing the primary key, the key generated by the database will be
   * bound back into the JavaBean. The same applies <i>mutatis mutandis</i> for
   * {@code Map} objects.
   */
  ...
  /**
   * Executes the INSERT statement and returns the key generated by the database.
   *
   * @return
   */
