...
public final class SQLInsert extends SQLStatement<SQLInsert> {
  ...
  private static final String CANNOT_SET_ID_PROPERTY
        = "cannot set ID property when key retrieval is disabled";
  private static final String CANNOT_SET_ID_KEY
        = "cannot set ID key when key retrieval is disabled";
