...
public interface BindInfo {
   ...
   * {@code null}. You may ignore any argument that you don't need in order to determine
   * the storage type. For example, in many cases just the Java type of a property will
   * likely be enough to determine the corresponding SQL type.
   *
